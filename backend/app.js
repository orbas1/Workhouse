...
const headhunterRoutes = require('./routes/headhunter');
...
const communitySubscriptionRoutes = require('./routes/communitySubscription');
...
app.use('/headhunter', headhunterRoutes);
...
app.use('/community', communitySubscriptionRoutes);
