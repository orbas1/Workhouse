export const menu = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Payments & Timesheets', path: '/payments/timesheets' },
      ...
      { label: 'Creator Analytics', path: '/creator/analytics' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Education Schedule', path: '/education/schedule' },
      { label: 'Courses', path: '/courses' },
      { label: 'Education Courses', path: '/education/courses' },
      { label: 'Classroom', path: '/classroom/WorkhouseClassroom' }
    ]
  },
  {
    heading: 'Community',
