...
import { Box, Heading, SimpleGrid, Stack, Spinner, useToast } from '@chakra-ui/react';
import AdCard from '../components/AdCard.jsx';
import AdPreferencesForm from '../components/AdPreferencesForm.jsx';
import { fetchAds, getAdPreferences } from '../api/ads.js';
import '../styles/SharedUserInteractionPage.css';

export default function SharedUserInteractionPage() {
